...
namespace pugi
{
	...
	xml_node* xml_node::next_sibling_pointer() const
	{
		if(empty()) return NULL;
		
		if (_root->next_sibling) return new xml_node(_root->next_sibling);
		else return NULL;
	}
	...
	xml_node* xml_node::first_child_pointer() const
	{
		if (_root) return new xml_node(_root->first_child);
		else return NULL;
	}
