...
namespace pugi
{
	...
	public:
		...
		/**
		 * Get following sibling's pointer
		 *
		 * \return pointer following sibling node, if any; NULL otherwise
		 */
		xml_node* next_sibling_pointer() const;
	...
	public:
		...
		/**
		 * Get the pointer to the first child
		 *
		 * \return pointer to first child, if any; NULL otherwise
		 */
		xml_node* first_child_pointer() const;
