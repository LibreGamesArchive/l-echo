...
void draw_sphere(double r)
{
	...
	glBegin(GL_QUAD_STRIP);
		glVertex3f(r * 0.000f, 0, r * 1.000f);
		glVertex3f(r * 0.383f, r * 0.000f, r * 0.924f);
		glVertex3f(r * 0.354f, r * 0.146f, r * 0.924f);
		glVertex3f(r * 0.000f, r * 0.000f, r * 1.000f);
		glVertex3f(r * 0.000f, r * 0.000f, r * 1.000f);
		glVertex3f(r * 0.271f, r * 0.271f, r * 0.924f);
		glVertex3f(r * 0.146f, r * 0.354f, r * 0.924f);
		glVertex3f(r * 0.000f, r * 0.000f, r * 1.000f);
		glVertex3f(r * 0.000f, r * 0.000f, r * 1.000f);
		glVertex3f(r * 0.000f, r * 0.383f, r * 0.924f);
		glVertex3f(r * -0.146f, r * 0.354f, r * 0.924f);
		glVertex3f(r * -0.000f, r * 0.000f, r * 1.000f);
		glVertex3f(r * -0.000f, r * 0.000f, r * 1.000f);
		glVertex3f(r * -0.271f, r * 0.271f, r * 0.924f);
		...
		glVertex3f(r * 0.000f, r * -0.000f, r * 1.000f);
		glVertex3f(r * 0.000f, r * -0.000f, r * 1.000f);
		glVertex3f(r * 0.383f, 0, r * 0.924f);
	glEnd();
	glBegin(GL_QUAD_STRIP);
		glVertex3f(r * 0.383f, 0, r * 0.924f);
		glVertex3f(r * 0.707f, r * 0.000f, r * 0.707f);
		glVertex3f(r * 0.653f, r * 0.271f, r * 0.707f);
		glVertex3f(r * 0.354f, r * 0.146f, r * 0.924f);
		glVertex3f(r * 0.271f, r * 0.271f, r * 0.924f);
		glVertex3f(r * 0.500f, r * 0.500f, r * 0.707f);
		glVertex3f(r * 0.271f, r * 0.653f, r * 0.707f);
		glVertex3f(r * 0.146f, r * 0.354f, r * 0.924f);
		glVertex3f(r * 0.000f, r * 0.383f, r * 0.924f);
		glVertex3f(r * 0.000f, r * 0.707f, r * 0.707f);
		glVertex3f(r * -0.271f, r * 0.653f, r * 0.707f);
		glVertex3f(r * -0.146f, r * 0.354f, r * 0.924f);
		glVertex3f(r * -0.271f, r * 0.271f, r * 0.924f);
		glVertex3f(r * -0.500f, r * 0.500f, r * 0.707f);
		...
		glVertex3f(r * 0.354f, r * -0.146f, r * 0.924f);
		glVertex3f(r * 0.383f, r * -0.000f, r * 0.924f);
		glVertex3f(r * 0.707f, 0, r * 0.707f);
	glEnd();
	glBegin(GL_QUAD_STRIP);
		glVertex3f(r * 0.707f, 0, r * 0.707f);
		glVertex3f(r * 0.924f, r * 0.000f, r * 0.383f);
		glVertex3f(r * 0.854f, r * 0.354f, r * 0.383f);
		glVertex3f(r * 0.653f, r * 0.271f, r * 0.707f);
		glVertex3f(r * 0.500f, r * 0.500f, r * 0.707f);
		glVertex3f(r * 0.653f, r * 0.653f, r * 0.383f);
		glVertex3f(r * 0.354f, r * 0.854f, r * 0.383f);
		glVertex3f(r * 0.271f, r * 0.653f, r * 0.707f);
		glVertex3f(r * 0.000f, r * 0.707f, r * 0.707f);
		glVertex3f(r * 0.000f, r * 0.924f, r * 0.383f);
		glVertex3f(r * -0.354f, r * 0.854f, r * 0.383f);
		glVertex3f(r * -0.271f, r * 0.653f, r * 0.707f);
		glVertex3f(r * -0.500f, r * 0.500f, r * 0.707f);
		glVertex3f(r * -0.653f, r * 0.653f, r * 0.383f);
		...
		glVertex3f(r * 0.653f, r * -0.271f, r * 0.707f);
		glVertex3f(r * 0.707f, r * -0.000f, r * 0.707f);
		glVertex3f(r * 0.924f, 0, r * 0.383f);
	glEnd();
	glBegin(GL_QUAD_STRIP);
		glVertex3f(r * 0.924f, 0, r * 0.383f);
		glVertex3f(r * 1.000f, r * 0.000f, r * 0.000f);
		glVertex3f(r * 0.924f, r * 0.383f, r * 0.000f);
		glVertex3f(r * 0.854f, r * 0.354f, r * 0.383f);
		glVertex3f(r * 0.653f, r * 0.653f, r * 0.383f);
		glVertex3f(r * 0.707f, r * 0.707f, r * 0.000f);
		glVertex3f(r * 0.383f, r * 0.924f, r * 0.000f);
		glVertex3f(r * 0.354f, r * 0.854f, r * 0.383f);
		glVertex3f(r * 0.000f, r * 0.924f, r * 0.383f);
		glVertex3f(r * 0.000f, r * 1.000f, r * 0.000f);
		glVertex3f(r * -0.383f, r * 0.924f, r * 0.000f);
		glVertex3f(r * -0.354f, r * 0.854f, r * 0.383f);
		glVertex3f(r * -0.653f, r * 0.653f, r * 0.383f);
		glVertex3f(r * -0.707f, r * 0.707f, r * 0.000f);
		...
		glVertex3f(r * 0.854f, r * -0.354f, r * 0.383f);
		glVertex3f(r * 0.924f, r * -0.000f, r * 0.383f);
		glVertex3f(r * 1.000f, 0, r * 0.000f);
	glEnd();
	glBegin(GL_QUAD_STRIP);
		glVertex3f(r * 1.000f, 0, r * 0.000f);
		glVertex3f(r * 0.924f, r * 0.000f, r * -0.383f);
